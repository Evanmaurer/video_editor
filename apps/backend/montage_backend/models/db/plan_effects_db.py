...
class PlanEffectsRow(Base):
    __tablename__ = "plan_effects_analyses"
    __table_args__ = (
        UniqueConstraint("plan_id", "engine_version", name="uq_plan_effects_plan_engine"),
        Index("idx_plan_effects_project", "project_id"),
    )
