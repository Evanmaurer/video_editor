...
from montage_backend.api.routes import analysis, media, metadata, montage, playback, projects, render, settings, timeline
...
api_router.include_router(montage.router)
