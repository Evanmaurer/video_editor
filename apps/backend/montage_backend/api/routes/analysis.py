...
@router.get(
    "/{project_id}/media/{media_id}/analysis/albion/ui",
    response_model=AlbionUiAnalysisResult | None,
)
async def get_albion_ui_analysis(
    ...
    return await service.get_albion_ui_analysis(project_id, media_id)


@router.get(
    "/{project_id}/media/{media_id}/analysis/albion/abilities",
    response_model=AlbionAbilityAnalysisResult | None,
)
async def get_albion_ability_analysis(
    ...
    return await service.get_albion_ability_analysis(project_id, media_id)


@router.get(
    "/{project_id}/media/{media_id}/analysis/albion/combat-timeline",
    response_model=AlbionCombatAnalysisResult | None,
)
...
@router.get(
    "/{project_id}/media/{media_id}/analysis/albion/engagement",
    response_model=AlbionEngagementAnalysisResult | None,
)
async def get_albion_engagement_analysis(
    ...
    return await service.get_albion_engagement_analysis(project_id, media_id)


@router.get(
    "/{project_id}/media/{media_id}/analysis/albion/highlights",
    response_model=AlbionHighlightAnalysisResult | None,
)
